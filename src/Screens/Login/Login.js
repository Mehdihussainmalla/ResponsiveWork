      ...
      <View style={styles.container}>
        ...
        <View style={styles.inputview}>
          ...
          <TouchableOpacity activeOpacity={0.7} style={styles.forgetview}>
            <Text style={styles.forgettext}>forgotpassword</Text>
          </TouchableOpacity>
          ...
          <View style={styles.addview}>
            <Text style={styles.notamem}>Not a Member?</Text>
            <TouchableOpacity
        ...
        <TouchableOpacity onPress={handleModal} style={{backgroundColor:'skyblue',height:40,justifyContent:'center',alignItems:'center'}}>
